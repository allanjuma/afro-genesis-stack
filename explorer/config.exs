...
# Chain configuration
config :explorer,
  coin: System.get_env("COIN", "AFRO"),
  coin_name: System.get_env("COIN_NAME", "Afro"),
...
config :block_scout_web,
  ...
  network_name: System.get_env("NETWORK", "Afro Network"),
  subnetwork: System.get_env("SUBNETWORK", "Afro Mainnet")
